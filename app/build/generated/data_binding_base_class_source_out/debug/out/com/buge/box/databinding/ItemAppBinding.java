...
public final class ItemAppBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton cloneButton;

  @NonNull
  public final TextView packageName;

  private ItemAppBinding(@NonNull MaterialCardView rootView, @NonNull ImageView appIcon,
      @NonNull TextView appName, @NonNull MaterialButton cloneButton,
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.cloneButton;
      MaterialButton cloneButton = ViewBindings.findChildViewById(rootView, id);
      if (cloneButton == null) {
        break missingId;
      }
      ...
      return new ItemAppBinding((MaterialCardView) rootView, appIcon, appName, cloneButton,
          packageName);
    }
